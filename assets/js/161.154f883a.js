...
var micromark_util_subtokenize = __webpack_require__(35380);
...
function resolveContent(events) {
  ;(0,micromark_util_subtokenize/* subtokenize */.w)(events)
  return events
}
...
function decode($0, $1, $2) {
  ...
  if (head === 35) {
    ...
    return (0,micromark_util_decode_numeric_character_reference/* decodeNumericCharacterReference */.C)($2.slice(hex ? 2 : 1), hex ? 16 : 10)
  }
...
/* harmony import */ var _createText_6b48ae7d_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5202);
...
/* harmony import */ var _createText_6b48ae7d_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(5202);
